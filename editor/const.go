...
var (
	...
	typeSizes   = map[ColType]uint64{BYTE: 1, INT16: 2, UINT16: 2, INT32: 4, UINT32: 4, FLOAT: 4, UINT64: 8}
	typeTitles  = map[ColType]string{BYTE: "Byte", INT16: "Int16", UINT16: "UInt16", INT32: "Int32", UINT32: "UInt32", FLOAT: "Float", STRING: "String", UINT64: "UInt64"}
